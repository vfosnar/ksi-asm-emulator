...
def parse_next_instruction(segment, IP): # Disassembler
    ...
    for arg in properties.split():
        ...
        match arg[0]:
            ...
            case "M":
                raise NotImplementedError("Not relevant for KSI emulator.")  # TODO: better hláška 
            case _:
...
MOD_00_RM = ["BX+SI","BX+DI","BP+SI","BP+DI", "SI", "DI", "BP", "BX"] # !! If mod=00, Místo BP je pouze displacement16!!
